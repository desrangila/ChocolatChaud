CREATE TABLE hour (id BIGINT AUTO_INCREMENT, user_id BIGINT NOT NULL, time DATETIME NOT NULL, created_at DATETIME, updated_at DATETIME, PRIMARY KEY(id)) ENGINE = INNODB;
